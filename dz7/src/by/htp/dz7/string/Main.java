...
System.out.println(s2);
	...
	System.out.println("Удалить из текста его часть, заключенную между двумя символами, которые вводятся (например, между скобками «(» и «)» или между звездочками «*» и т. п.).");
	...
	System.out.println("Стр. 90 задача 1, 6, 9, решить тестовое задание на стр. 51, вариант А задача 8, вариант С задача 3, задача 12");
